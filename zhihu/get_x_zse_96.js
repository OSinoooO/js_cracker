...
function btoa(s) {
    return  new Buffer.from(s, "binary").toString("base64")
}


function get_val_1(val) {
    function i(e, t) {
    ...
    function a(e, t, n, r, o, a) {
        return i((c = i(i(t, e), i(r, a))) << (u = o) | c >>> 32 - u, n);
        var c, u
    }
...
function get_sign(val) {
    const ret = get_val_1(val)
    const result = get_val_2(ret);
    return result.slice(0,-4);
}

// 传入参数其中有段值是从cookie中获取的【d_c0】
str = "101_3_2.0+/api/v4/search_v3?t=general&q=b%E7%AB%99&correction=1&offset=0&limit=20&filter_fields=&lc_idx=0&show_all_topics=0+\"AOBdSTwwaROPTnVqm6i02TKL8ICvqjxNO7A=|1626256589\""
console.log(get_sign(str));